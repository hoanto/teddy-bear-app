...
const { chartCount, chartUserStat, chartOrderStat, chartRevenue } =
...
onMounted(() => {
  getOrders({ orderStatus: ORDER_STATUS.PENDING });
  getUsers();
  getCount();
  getUserStat();
  getOrderStat();
...
<template>
  <div class="dashboard-container">
    ...
    <div class="dashboard-main">
      <el-card class="table" style="margin-right: 35px; height: 530px">
