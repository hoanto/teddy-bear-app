    ...
    <el-table :data="props.data" style="width: 100%;">
      ...
      >
        <template v-slot="scope">
          ...
          <div v-if="column.prop === 'descImages'">
            <div v-for="(item, index) in scope.row[column.prop]" :key="index">
              <img :src="item" alt="image" style="width: 100px; height: auto" />
            </div>
          </div>

          <div v-if="column.prop === 'descItems'">
            <div v-for="(item, index) in scope.row[column.prop]" :key="index">
              <img
                :src="item.image"
                alt="image"
