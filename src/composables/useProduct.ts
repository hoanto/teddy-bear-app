...
export const useProduct = () => {
  ...
  const getProductSellTheMost = async () => {
    try {
      ...
      productStore.setProductSellTheMost(data);
  ...
  const createDescProduct = async (payload: any) => {
    try {
      const response = await request.post("/details", payload);
  ...
  const updateDescProduct = async (payload: any, id: number) => {
    try {
      const response = await request.put(`/details/${id}`, payload);
  ...
  const getDescProduct = async () => {
    try {
      const response = await request.get("/details");

      const { data } = response.data as TResult;

      productStore.setDescList(data);
  ...
  const getSingleDescProduct = async (productId: number) => {
    try {
      const response = await request.get(`/details/${productId}`);

      const { data } = response.data as TResult;

      productStore.setSingleDesc(data);
  ...
  const getSingleDescByProduct = async (productId: number) => {
    try {
      const response = await request.get(
        `/details/by-product/${productId}`
      );
  ...
  const deleteDescProduct = async (id: number) => {
    try {
      const response = await request.delete(`/details/${id}`);
