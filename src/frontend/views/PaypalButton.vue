    ...
    window.paypal
      .Buttons({
        createOrder: (data: any, actions: any) => {
          console.log('(props.total / 250000).toFixed(2)',(props.total / 250000).toFixed(2))
          return actions.order.create({
            purchase_units: [
              {
                amount: {
                  value: (props.total / 250000).toFixed(2), // Ensure value is a string with 2 decimal places
                },
              },
            ],
          });
